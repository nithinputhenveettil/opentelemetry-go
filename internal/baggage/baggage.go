...
`github.com/nithinputhenveettil/opentelemetry-go/baggage` package would be the singular place where
W3C baggage is handled.
*/
package baggage // import "github.com/nithinputhenveettil/opentelemetry-go/internal/baggage"

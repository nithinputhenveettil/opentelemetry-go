...
it is reusable. See [github.com/nithinputhenveettil/opentelemetry-go/sdk/metric] for the official
...
[github.com/nithinputhenveettil/opentelemetry-go/metric/embedded]. If an author wants the default
behavior of their implementations to be a compilation failure, signaling to
their users they need to update to the latest version of that implementation,
they need to embed the corresponding interface from
[github.com/nithinputhenveettil/opentelemetry-go/metric/embedded] in their implementation. For
example,

	import "github.com/nithinputhenveettil/opentelemetry-go/metric/embedded"
...
they need to embed the API interface directly.
	...
	import "github.com/nithinputhenveettil/opentelemetry-go/metric"
...
of [github.com/nithinputhenveettil/opentelemetry-go/metric].
...
[github.com/nithinputhenveettil/opentelemetry-go/metric/noop]:
	...
	import "github.com/nithinputhenveettil/opentelemetry-go/metric/noop"
...
[github.com/nithinputhenveettil/opentelemetry-go/metric/noop] if they choose this default behavior.
...
[GetMeterProvider]: https://pkg.go.dev/github.com/nithinputhenveettil/opentelemetry-go#GetMeterProvider
*/

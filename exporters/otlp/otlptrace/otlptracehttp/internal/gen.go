...
package internal // import "github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp/internal"
...
//go:generate gotmpl --body=../../../../../internal/shared/otlp/otlptrace/otlpconfig/envconfig.go.tmpl "--data={\"envconfigImportPath\": \"github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp/internal/envconfig\"}" --out=otlpconfig/envconfig.go
//go:generate gotmpl --body=../../../../../internal/shared/otlp/otlptrace/otlpconfig/options.go.tmpl "--data={\"retryImportPath\": \"github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp/internal/retry\"}" --out=otlpconfig/options.go
//go:generate gotmpl --body=../../../../../internal/shared/otlp/otlptrace/otlpconfig/options_test.go.tmpl "--data={\"envconfigImportPath\": \"github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp/internal/envconfig\"}" --out=otlpconfig/options_test.go
...
//go:generate gotmpl --body=../../../../../internal/shared/x/x.go.tmpl "--data={ \"pkg\": \"github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp\" }" --out=x/x.go

//go:generate gotmpl --body=../../../../../internal/shared/counter/counter.go.tmpl "--data={ \"pkg\": \"github.com/nithinputhenveettil/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp/internal/counter\" }" --out=counter/counter.go

...
// that will let you create a [github.com/nithinputhenveettil/opentelemetry-go/metric.Meter].
//
...
func Example() {
	...
	// data. See https://pkg.go.dev/github.com/nithinputhenveettil/opentelemetry-go/exporters for
